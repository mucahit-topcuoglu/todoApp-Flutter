          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(
              child: Column(
                ...
                children: [
                  Lottie.asset('assets/lottie/empty.json', width: 180, repeat: true),
                  const SizedBox(height: 24),
                  Text('Henüz challenge yok. Hemen bir tane ekle!', style: GoogleFonts.montserrat(fontSize: 18, color: Colors.white70)),
                ],
              ),
            );
          }
            ...
            return Center(
              child: Column(
                ...
                children: [
                  Lottie.asset('assets/lottie/empty.json', width: 180, repeat: true),
                  const SizedBox(height: 24),
                  Text('Bu ay için challenge yok.', style: GoogleFonts.montserrat(fontSize: 18, color: Colors.white70)),
                ],
              ),
            );
          }
